...
function CaseAnalyticsDashboard({ user, users, factions, checksMeta, enabledSubjects }) {
  ...
  return React.createElement("div", null,
    ...
    React.createElement("div", { className: "stat-row", style: { display: "flex", gap: 10, marginBottom: 20, flexWrap: "wrap" } },
      ...
      statBox("Жалоб", a.byType?.complaint || 0, "#7b2d8b"),
    ),
    ...
    // By subject
    Object.keys(a.bySubject || {}).length > 1 && React.createElement("div", { style: { ...S.card, marginBottom: 16 } },
      React.createElement("h3", { style: { fontSize: 16, fontWeight: 700, color: C.text, marginBottom: 12 } }, "По субъектам"),
      React.createElement("div", { className: "responsive-table-wrap" },
        React.createElement("table", { style: S.table },
          React.createElement("thead", null,
            React.createElement("tr", null,
              React.createElement("th", { style: S.th }, "Субъект"),
              React.createElement("th", { style: S.th }, "Всего"),
              React.createElement("th", { style: S.th }, "В работе"),
              React.createElement("th", { style: S.th }, "Просрочено"),
            ),
          ),
          React.createElement("tbody", null,
            ...Object.entries(a.bySubject).sort((a, b) => b[1].total - a[1].total).map(([sub, stats]) =>
              React.createElement("tr", { key: sub, className: "row-hover" },
                React.createElement("td", { style: S.td, "data-label": "Субъект" }, sub),
                React.createElement("td", { style: S.td, "data-label": "Всего" }, stats.total),
                React.createElement("td", { style: S.td, "data-label": "В работе" }, stats.active),
                React.createElement("td", { style: { ...S.td, color: stats.overdue > 0 ? C.danger : C.text, fontWeight: stats.overdue > 0 ? 700 : 400 }, "data-label": "Просрочено" }, stats.overdue),
              ),
            ),
          ),
        ),
